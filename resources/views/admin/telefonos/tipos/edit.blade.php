@extends('layouts.app')
@section('title', 'Editar Tipo de Teléfono: '.$telefonostipo->name)
...
@section('content')
    {!! Form::open([
        'route'=>['telefonostipos.update', $telefonostipo->id],
        'method'=>'PUT',
    ...
    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('name', $telefonostipo->name, ['class' => 'form-control', 'placeholder'=>'Tipo de Teléfono', 'required']) !!}
