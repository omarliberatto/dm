...
@section('content')
    ...
    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Ubicación', 'required']) !!}
    ...
    <div class="form-group {{ $errors->has('ini_range') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('ini_range', null, ['class' => 'form-control', 'placeholder'=>'Rango inicial']) !!}
    ...
    <div class="form-group {{ $errors->has('end_range') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('end_range', null, ['class' => 'form-control', 'placeholder'=>'Rango final']) !!}
