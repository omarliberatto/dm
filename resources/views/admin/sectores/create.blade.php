...
@section('content')
    ...
    <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder'=>'Sector', 'required']) !!}
    ...
    <div class="form-group {{ $errors->has('description') ? ' has-error' : '' }}">
        {!! Form::label('ubicacion_id', 'Area', ['class' => 'col-md-4 control-label']) !!}
        <div class="col-md-6">
            {!!
               Form::select('ubicacion_id', $areas, null, ['class' => 'form-control select-ubicacion', 'placeholder' => 'Seleccione el Area', 'required'] );
           !!}
